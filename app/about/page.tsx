...
const boardMembers = [
  {
    ...
    bio: "Founded The Mindful Group and developed innovative workforce training models. A decade of experience in workforce development. Wisconsin's state-selected expert in career and technical education, consulting for school districts and government agencies in Wisconsin and Tennessee.",
  },
  {
    name: "Regina Flores",
    role: "Board Chair",
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16">
            <div>
              ...
              <div className="space-y-4 text-text-light leading-relaxed">
                ...
                <p>Since 2018, we&apos;ve trained 525+ people with a 90% graduation rate and 85% job placement. We partner with community leaders, schools, and businesses. And we&apos;re part of a larger ecosystem — House Reed — engineered specifically to reverse urban poverty.</p>
              </div>
            </div>
            <div>
