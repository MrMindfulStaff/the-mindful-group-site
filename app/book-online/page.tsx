        ...
        <div className="relative z-[2] max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap gap-6 text-white/50 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:4146003745" className="text-white/50 hover:text-white transition-colors">414-600-3745</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-surface py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-text-light mb-8">
            Call us at <a href="tel:4146003745" className="text-primary hover:text-primary-light transition-colors font-semibold">414-600-3745</a> or send us a message. We&apos;re here to help you find the right path.
          </p>
          <Link
            href="/contact"
