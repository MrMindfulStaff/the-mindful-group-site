    ...
    <>
      ...
      <section className="bg-surface py-24">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h3 className="font-semibold text-text text-sm uppercase tracking-wider mb-6">Program Details</h3>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-heading text-text mb-6">Need Child Care <span className="text-primary">Help?</span></h2>
          <p className="text-text-light text-lg mb-10">Contact us to discuss your situation and learn about eligibility.</p>
