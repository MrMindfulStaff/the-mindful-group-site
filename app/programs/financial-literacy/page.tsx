    ...
    <>
      <section className="pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-6xl font-heading text-text leading-tight mb-8">Financial <span className="text-primary">Literacy</span></h1>
          <p className="text-text-light text-lg max-w-3xl mb-10">Master your finances. Learn budgeting, saving, and investing to make informed decisions that build long-term wealth and stability.</p>
        </div>
      </section>
      ...
      <section className="bg-surface py-24">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-2xl md:text-3xl font-heading text-text mb-6">Master Your Money</h2>
          ...
          <div>
            <h3 className="text-text font-semibold text-sm uppercase tracking-wider mb-6">Topics Covered</h3>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-heading text-text mb-6">Interested?</h2>
          <p className="text-text-light text-lg mb-10">Contact us to learn about upcoming Financial Literacy sessions.</p>
          <Link href="/contact" className="inline-block px-8 py-4 bg-accent text-white font-semibold text-sm uppercase tracking-wider rounded-md hover:bg-accent-light transition-colors">Contact Us</Link>
        </div>
      </section>
    </>
  );
