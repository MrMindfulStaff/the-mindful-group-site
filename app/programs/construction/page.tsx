    ...
    <>
      <section className="pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            <span className="text-[10px] uppercase tracking-[0.2em] border border-gold/20 text-gold/60 px-2 py-0.5">Trades</span>
          ...
          <h1 className="text-4xl md:text-6xl font-heading text-ivory leading-tight mb-8">
            Construction <span className="text-gold">Training</span>
          </h1>
          ...
          <a href="https://www.themindfulgroupinc.org/service-page/construction-training-orientation" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-4 bg-gold text-obsidian font-semibold text-sm uppercase tracking-wider hover:bg-gold-light transition-colors">Book Orientation</a>
        </div>
      </section>
      ...
      <section className="bg-obsidian-light py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 md:gap-16">
            <div>
              <h2 className="text-2xl md:text-3xl font-heading text-ivory mb-6">Build Skills. Build Homes. Build Your Future.</h2>
            ...
            <div>
              ...
              <div className="mt-8 p-6 border border-gold/10">
                <h4 className="text-ivory text-sm uppercase tracking-wider mb-3">Homeownership Pathway</h4>
                <p className="text-silver text-sm leading-relaxed">Graduates are eligible for the Mindful Way Homeowner Program — rent-to-own homes remodeled through the training program itself.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-heading text-ivory mb-6">Ready to <span className="text-gold">Build?</span></h2>
          <p className="text-silver text-lg mb-10">Book a free orientation to learn about the program and start your career in the trades.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://www.themindfulgroupinc.org/service-page/construction-training-orientation" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-gold text-obsidian font-semibold text-sm uppercase tracking-wider hover:bg-gold-light transition-colors">Book Orientation</a>
            <Link href="/contact" className="px-8 py-4 border border-gold/40 text-gold text-sm uppercase tracking-wider hover:bg-gold/10 transition-colors">Ask a Question</Link>
          </div>
        </div>
      </section>
    </>
