    ...
    <>
      ...
      <section className="relative pt-16 pb-12 bg-gradient-to-br from-secondary via-secondary to-primary overflow-hidden min-h-[70vh]">
        ...
        <div className="absolute inset-0 z-[1] overflow-hidden">
          ...
          <svg className="absolute -bottom-1 left-0 w-[200%] h-64 md:h-80 animate-[wave_18s_ease-in-out_infinite]" viewBox="0 0 2400 200" preserveAspectRatio="none">
            <path d="M0,100 C400,160 800,40 1200,100 C1600,160 2000,40 2400,100 L2400,200 L0,200 Z" fill="#1A7A5C" fillOpacity="0.25" />
          </svg>
          {/* Medium wave - accent orange */}
          <svg className="absolute -bottom-1 left-0 w-[200%] h-52 md:h-72 animate-[wave_14s_ease-in-out_infinite_reverse]" viewBox="0 0 2400 200" preserveAspectRatio="none">
            <path d="M0,120 C300,60 600,180 1200,80 C1800,0 2100,160 2400,120 L2400,200 L0,200 Z" fill="#E07C3E" fillOpacity="0.15" />
          </svg>
