...
export default function StellarEngineTurbine() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#111d2a] flex">
      {/* Compact sidebar */}
      <div className="w-56 lg:w-64 shrink-0 bg-black/50 backdrop-blur-md border-r border-white/[0.03] flex flex-col overflow-y-auto">
        <Link href="/" className="flex items-center gap-2 px-5 py-3 border-b border-white/[0.04] text-white/40 text-[10px] uppercase tracking-wider hover:bg-white/[0.04] transition-colors">
